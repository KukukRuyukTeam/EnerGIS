...
<body>
    <div style="background-image: url('image/banner.png');background-size: 100% 100%;background-repeat: no-repeat;">
        ...
        <div style="padding: 5%;width: 90%;background-color: none;height: 50vh;">
            <div style="display: flex;margin-top: 1%;margin-bottom: 2%;justify-content: center;flex-direction: column;align-items: center;">
                <span style="color: WHITE;font-size: 48PX;font-family: poppins;font-weight: 800;text-align: center;"><span style="color: #B9D7FF;">Keberlanjutan</span> Dimulai<br>Dengan Energi <span style="color: #B9D7FF;">Terbarukan</span></span>
    ...
    <div style="display: flex;margin-top: 25vh;width: 80%;margin-left: 10%;margin-bottom: 10vh;">
        ...
        <div style="display: flex;flex-direction: column;">
            ...
            <button style="background-color: white;color: #91B1DB;border-radius: 20px;border-color: #91B1DB;height: 5vh;border-style: solid;width: 25%;margin-top: 5%;font-family: poppins;">Lihat selengkapnya</button>
        </div>
    </div>
    ...
    <div style="display: flex;justify-content: space-between;">
        ...
        <span class="judul jumlah-listrik" style="margin-left: 2%;width: 10%;">66000MW+<br><span style="color: #333333;font-size: 15px;">Listrik dihasilkan</span></span>
        <span class="judul pembangkit-listrik" style="color: #6D6D6D;margin-left: 4%;width: 12%;">300+<br><span style="color: #333333;font-size: 15px;">Pembangkit listrik</span></span>
        <span class="judul charging-station" style="color: #43CF2C;margin-left: 0;width: 15%;">800+<br><span style="color: #333333;font-size: 15px;">SPKLU</span></span>
    </div>
    <img src="image/peta_penyebaran.png" class="peta-penyebaran" width="90%" style="margin-left: 5%;margin-top: 2%;">
